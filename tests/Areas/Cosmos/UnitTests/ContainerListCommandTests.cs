...
namespace AzureMcp.Tests.Areas.Cosmos.UnitTests
{
    ...
    public class ContainerListCommandTests
    {
        ...
        public async Task ExecuteAsync_ReturnsContainers_WhenContainersExist()
        {
            ...
            var result = JsonSerializer.Deserialize<ContainerListCommandResult>(json);
        ...
        [Theory]
        [InlineData("--account-name", "account123", "--database-name", "database123")] // Missing subscription
        [InlineData("--subscription", "sub123", "--database-name", "database123")] // Missing account-name
        [InlineData("--subscription", "sub123", "--account-name", "account123")] // Missing database-name
        ...
        private class ContainerListCommandResult
        {
